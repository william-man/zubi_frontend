...
const About = () => {
  return (
    <Layout>
      <div className="mt-16 p-4 md:p-8 lg:p-12 text-zubiText"> {/* Added mt-16 to prevent overlap */}
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 text-zubiLogo"> {/* Heading color as yellow, responsive size */}
          About Us
        </h1>
